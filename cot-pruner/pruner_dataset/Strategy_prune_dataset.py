...
def main():
    # ================= 路径配置 =================
    INPUT_FILE = "/ai/111/Dataset/Strategy_QA/Base_DeepscaleR_Strategy/Strategy_StandardStep_MinCorrect.json"
    OUTPUT_DIR = "/ai/111/Dataset/Strategy_QA/DeepscaleR_StrategyQA_pruned"
    ...
    pruner = CoTPruner(
        ...
        causal_batch_size=32, # A6000 建议 32 更稳
